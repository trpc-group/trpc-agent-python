...
"""Conftest for artifacts tests.

Monkeypatches ArtifactEntry to accept both ``version`` and ``artifact_version``
keyword arguments and expose both as attributes, bridging the naming mismatch
between the dataclass definition and its usage in _in_memory_artifact_service.
"""
