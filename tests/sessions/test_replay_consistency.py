...
报告产物:tests/sessions/artifacts/session_memory_summary_diff_report.json。
"""
...
REPORT_PATH = str(Path(__file__).parent / "artifacts" / "session_memory_summary_diff_report.json")
