...
def test_lazy_import_dynamic_agent_tool_from_tools() -> None:
    """DynamicAgentTool is lazily re-exported from trpc_agent_sdk.tools."""
    from trpc_agent_sdk.tools import DynamicAgentTool
    from trpc_agent_sdk.agents.sub_agent import DynamicAgentTool as DirectTool
    assert DynamicAgentTool is DirectTool
