...
class TestOpenAIResponsesAPI:
    ...
    @pytest.mark.asyncio
    async def test_responses_maps_thinking_budget_to_reasoning_effort(self):
        """The Responses path should map thinking_budget to reasoning.effort
        so that reasoning depth can be controlled."""
