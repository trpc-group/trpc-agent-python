...
"""Unit tests for trpc_agent_sdk.server.a2a_v1._application."""
...
from trpc_agent_sdk.server.a2a_v1._application import _ensure_v0_3_interface
from trpc_agent_sdk.server.a2a_v1._application import _jsonrpc_path_from_card
from trpc_agent_sdk.server.a2a_v1._application import create_a2a_application
...
class TestCreateA2aApplication:
    ...
    def test_default_builds_default_handler(self):
        ...
        with patch("trpc_agent_sdk.server.a2a_v1._application.DefaultRequestHandler") as MockHandler:
            create_a2a_application(svc)
    ...
    def test_missing_url_warns_but_starts(self):
        ...
        with patch("trpc_agent_sdk.server.a2a_v1._application.logger.warning") as mock_warn:
...
# ---------------------------------------------------------------------------
# a2a-sdk 1.x route-factory kwargs used by create_a2a_application
# ---------------------------------------------------------------------------
class TestSdkRouteFactorySignatures:
    """Compat assembly TypeErrors if these kwargs disappear from a2a-sdk 1.x."""

    def test_create_agent_card_routes_accepts_card_url(self):
        from a2a.server.routes import create_agent_card_routes

        params = inspect.signature(create_agent_card_routes).parameters
        assert "card_url" in params, (
            "create_a2a_application(enable_v0_3_compat=True) passes "
            "card_url='/.well-known/agent.json' to create_agent_card_routes"
        )

    def test_create_jsonrpc_routes_accepts_enable_v0_3_compat(self):
        from a2a.server.routes import create_jsonrpc_routes

        params = inspect.signature(create_jsonrpc_routes).parameters
        assert "enable_v0_3_compat" in params
