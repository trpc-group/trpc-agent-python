...
"""Unit tests for trpc_agent_sdk.server.a2a_v1.converters._event_converter."""
...
from trpc_agent_sdk.server.a2a_v1.converters._event_converter import (
...
class TestA2aPartRequestsEucAuth:
    ...
    def test_skips_metadata_to_dict_for_non_data_part(self, kind):
        part = _non_data_part(kind, {"k": "v"})
        with patch(
            "trpc_agent_sdk.server.a2a_v1.converters._event_converter._metadata_to_dict"
        ) as mock_to_dict:
            assert _a2a_part_requests_euc_auth(part) is False
