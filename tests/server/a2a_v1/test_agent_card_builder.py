...
"""Unit tests for trpc_agent_sdk.server.a2a_v1._agent_card_builder."""
...
from trpc_agent_sdk.server.a2a_v1._agent_card_builder import (
    AgentCardBuilder,
...
from trpc_agent_sdk.server.a2a_v1._constants import EXTENSION_TRPC_A2A_VERSION, INTERACTION_SPEC_VERSION
...
class TestAgentCardBuilderBuild:
    ...
    async def test_build_raises_runtime_error_on_failure(self):
        ...
        with patch(
            "trpc_agent_sdk.server.a2a_v1._agent_card_builder._build_primary_skills",
...
class TestBuildLlmAgentSkills:
    ...
    @patch("trpc_agent_sdk.server.a2a_v1._agent_card_builder.convert_toolunion_to_tool_list")
