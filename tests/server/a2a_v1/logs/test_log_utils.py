...
"""Unit tests for trpc_agent_sdk.server.a2a_v1.logs._log_utils."""
...
from trpc_agent_sdk.server.a2a_v1.logs._log_utils import (
    _is_a2a_data_part,
    _is_a2a_message,
    _is_a2a_task,
    _is_a2a_text_part,
...
class TestIsA2aTask:
    ...
    def test_duck_type_fallback(self):
        ...
        obj = FakeTask()
        with patch("trpc_agent_sdk.server.a2a_v1.logs._log_utils.A2ATask", "not_a_type"):
...
class TestIsA2aMessage:
    ...
    def test_duck_type_fallback(self):
        ...
        obj = FakeMessage()
        with patch("trpc_agent_sdk.server.a2a_v1.logs._log_utils.A2AMessage", "not_a_type"):
