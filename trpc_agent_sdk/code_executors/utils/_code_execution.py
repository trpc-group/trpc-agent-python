...
class CodeExecutionUtils:
    ...
    def convert_code_execution_parts(
        ...
        if content.parts[-1].executable_code:
            content.parts[-1] = Part(text=(code_block_delimiter.start + content.parts[-1].executable_code.code +
                                           code_block_delimiter.end))
        ...
        # likely generated by the model.
            ...
            content.parts[-1] = Part(text=execution_result_delimiters.start +
                                     content.parts[-1].code_execution_result.output + execution_result_delimiters.end)
            content.role = 'user'
