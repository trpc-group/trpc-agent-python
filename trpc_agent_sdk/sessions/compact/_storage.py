...
def _expire_memory_dir(memory_dir: Path, config: AdvancedCompactConfig) -> bool:
...
def _expire_session_dir(session_dir: Path, config: AdvancedCompactConfig) -> bool:
...
class LongTermMemoryStore:
    ...
    def __init__(self, config: AdvancedCompactConfig, paths: AdvancedMemoryPaths | None = None) -> None:
...
class LocalAdvancedMemoryCleanup:
    ...
    def __init__(self, config: AdvancedCompactConfig) -> None:
        self._config = config
