...
"""Per-session / per-branch locks for :class:`GoalRecord` read-modify-write."""
...
def store_lock_key(
    ...
    *,
    ...
    """Build a stable key for the branch-scoped goal."""
...
@asynccontextmanager
async def goal_store_lock(
    tool_context: InvocationContext,
    *,
    prefix: str,
    branch: str,
) -> AsyncIterator[None]:
    """Serialize load / mutate / save for one session goal."""
