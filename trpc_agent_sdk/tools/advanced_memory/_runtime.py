...
from trpc_agent_sdk.sessions.compact.advanced._coordination import CrossLoopLock
from ._storage_key import AdvancedMemoryPaths
from ._storage_key import AdvancedMemoryScope
from ._file_storage import LocalAdvancedMemoryCleanup
...
class AdvancedMemoryRuntime:
    ...
    _scoped_runtimes: dict[AdvancedMemoryScope, "ScopedAdvancedMemoryRuntime"] = field(
    ...
    def create(cls, config: AdvancedMemoryConfig | None = None) -> "AdvancedMemoryRuntime":
        ...
        if resolved_config.storage_backend == "redis":
            ...
            from ._sql_storage import AdvancedMemorySqlBase, SqlAdvancedMemoryCleanup
    ...
    def for_scope(self, app_name: str, user_id: str) -> "ScopedAdvancedMemoryRuntime":
        ...
        scope = AdvancedMemoryScope(app_name, user_id)
        with self._scoped_runtimes_lock:
            ...
            if runtime is None:
                ...
                if self.config.storage_backend == "redis":
                    from trpc_agent_sdk.storage import RedisStorage
                    from ._redis_storage import RedisLongTermMemoryStore
                    ...
                    from ._sql_storage import SqlLongTermMemoryStore
