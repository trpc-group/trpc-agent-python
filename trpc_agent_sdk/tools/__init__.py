...
if TYPE_CHECKING:
    ...
    from trpc_agent_sdk.agents.sub_agent import DynamicAgentTool as DynamicAgentTool  # noqa: F401
...
_LAZY_REEXPORTS = {
    "DynamicAgentTool": ("trpc_agent_sdk.agents.sub_agent", "DynamicAgentTool"),
