...
if TYPE_CHECKING:
    from .advanced_memory import AdvancedMemoryRuntime
    from .advanced_memory import AdvancedMemoryServiceConfig
    from .advanced_memory import LongTermMemoryIntegration
