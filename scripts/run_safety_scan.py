...
"""Batch scan 38 safety samples and produce report + audit artifacts.
...
EXPECTED = {
    ...
    "37": "deny",  # dd if= prefix denied command matches valued args
    "38": "allow",  # github.com allowlist covers subdomains
}
