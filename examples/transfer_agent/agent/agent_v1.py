...
"""Transfer Agent example with TrpcRemoteA2aAgent as custom agent (a2a-sdk 1.x)."""
...
def create_agent() -> TransferAgent:
    ...
    # The remote A2A service address. When it points at a local port, run_agent_v1.py
    # auto-starts an embedded server on that same port.
