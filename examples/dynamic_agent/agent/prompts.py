...
#
"""Orchestrator instructions for the dynamic_agent example."""

MINIMAL_ORCHESTRATOR_INSTRUCTION = """\
You are an orchestrator. You have three direct tools (calculator, current_time, \
word_count) and a special 'dynamic_agent' tool that runs a short-lived sub-agent.

Use direct tools for simple one-step answers. Use 'dynamic_agent' according to \
...
You are an orchestrator. Your ONLY tool is 'dynamic_agent', which runs a \
