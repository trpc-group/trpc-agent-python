    ...
    try:
        ...
        if result is not None:
            ...
            for eval_set_id, nc in nc_by_set.items():
                n, c = nc.n, nc.c
                pass_2 = AgentEvaluator.pass_at_k(n, c, 2)
                pass_5 = AgentEvaluator.pass_at_k(n, c, 5)
                pass_hat_2 = AgentEvaluator.pass_hat_k(n, c, 2)
                pass_hat_5 = AgentEvaluator.pass_hat_k(n, c ,5)
                print(
                    f"EvalSet {eval_set_id}: n={n}, c={c}, "
                    f"pass@2={pass_2:.4f}, pass@5={pass_5:.4f}, pass^2={pass_hat_2:.4f}, pass^5={pass_hat_5:.4f}"
                )
