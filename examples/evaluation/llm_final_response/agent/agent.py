...
"""Simple QA agent for llm_final_response evaluator demo."""
...
def create_agent() -> LlmAgent:
    """Create the agent for llm_final_response demo."""
    return LlmAgent(
        name="llm_final_response_agent",
        description="简单问答助手，可查天气",
        model=_create_model(),
        instruction=(
            "你是问答助手。用户问天气时用 get_weather 查询后简洁回答，"
            "例如只回答温度与天气状况。"
        ),
