...
import os
import pytest
from trpc_agent_sdk.evaluation import AgentEvaluator, LLM_EVALUATOR_REGISTRY
...
# 为 llm_rubric_response 的 judge agent 注册工具；
# rubric 中已规定「必须先调用 get_eval_policy 再按返回条款判定」
