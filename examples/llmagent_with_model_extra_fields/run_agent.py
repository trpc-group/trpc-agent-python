...
"""Run the model extra fields weather agent example."""
...
async def run_weather_agent() -> None:
    """Run the weather query agent with model-level extra fields enabled."""
    app_name = "model_extra_fields_weather_demo"
