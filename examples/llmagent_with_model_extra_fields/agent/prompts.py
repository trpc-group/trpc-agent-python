...
"""Prompts for the model extra fields example agent."""
...
After receiving tool results, summarize the weather clearly and mention the extra fields only if the user asks about them.
"""
