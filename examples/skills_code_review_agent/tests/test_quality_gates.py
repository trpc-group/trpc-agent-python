...
def test_high_risk_recall_and_false_positive_quality_gate():
    positives = [
        ("secret.py", ["API_KEY = 'sk-abcdefghijklmnop'"], FindingCategory.SECRET),
        ...
        ("tokens.py", ["password = 'correct-horse-battery-staple'"], FindingCategory.SECRET),
    ]
    hits = 0
...
def test_redaction_quality_gate_covers_common_secret_shapes():
    cases = [
        ...
        ("token=github_pat_abcdefghijklmnop", ["github_pat_abcdefghijklmnop"]),
        ("token=ghp_abcdefghijklmnop", ["ghp_abcdefghijklmnop"]),
        ("token=gho_abcdefghijklmnop", ["gho_abcdefghijklmnop"]),
        ("slack_token=xoxb-example-value-abcdefghijklmnop", ["xoxb-example-value-abcdefghijklmnop"]),
        ("aws_key=AKIAABCDEFGHIJKLMNOP", ["AKIAABCDEFGHIJKLMNOP"]),
        ("aws_session=ASIAABCDEFGHIJKLMNOP", ["ASIAABCDEFGHIJKLMNOP"]),
        ...
        ("jwt_token=eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIxMjMifQ.signature", ["eyJhbGciOiJIUzI1NiJ9"]),
    ]
