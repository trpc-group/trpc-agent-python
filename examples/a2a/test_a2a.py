...
- 1.0 client -> v0.3 server: ``A2A_V03_COMPAT=1 python3 test_a2a.py``
  (compat mode auto-negotiates the v0.3 wire for a not-yet-upgraded server)
"""
...
async def main():
    ...
    # Default to the 1.0 wire (auto negotiation).  Set A2A_V03_COMPAT=1 to
    # enable compat mode, which auto-negotiates 1.0/0.3 and falls back to the
    # v0.3 wire for a not-yet-upgraded v0.3 server.
