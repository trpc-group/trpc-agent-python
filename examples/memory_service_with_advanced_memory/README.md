...
本示例演示如何使用 `AdvancedMemory` 在本地实现持久化的跨会话记忆。
...
应用代码显式创建 `AdvancedMemory`，将其工具传入 Agent，并调用 `configure_agent(agent)` 配置记忆索引回调。具体的记忆保存和读取由 Agent 根据工具描述主动完成。
...
📊 {'saved': True, 'filename': 'favorite_programming_language.md', 'path': '.../examples/memory_service_with_advanced_memory/tenants/advanced_memory_demo/demo-user/MEMORY/favorite_programming_language.md', 'memory_type': 'user', 'updated_at': '2026-09-11T05:17:54.071665+00:00'}
...
📊 {'saved': True, 'filename': 'favorite_programming_language.md', 'path': '.../examples/memory_service_with_advanced_memory/tenants/advanced_memory_demo/demo-user/MEMORY/favorite_programming_language.md', 'memory_type': 'user', 'updated_at': '2026-09-11T05:17:56.582892+00:00'}
