...
def create_session_service() -> InMemorySessionService:
    ...
    compact_manager = AdvancedAutoCompactSummarizerManager(summarizer=AdvancedAutoCompactSummarizer(
...
def create_advanced_memory() -> AdvancedMemory:
    ...
    return AdvancedMemory(config=memory_config)
...
async def main() -> None:
    ...
    advanced_memory = create_advanced_memory()
