...
- [examples/transfer_agent](./examples/transfer_agent/README.md) - `TransferAgent` handoff (`run_agent_v1.py` for `[a2a-v1]`, `run_agent.py` for `[a2a]`)
...
- [examples/multi_tenant_im_agent](./examples/multi_tenant_im_agent/README.md) - Multi-tenant Telegram/WeCom gateway with shared sessions, idempotency, audit, and deployment manifests
