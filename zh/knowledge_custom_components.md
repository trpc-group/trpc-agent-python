...
一个按separator分割符分割文本的示例如下，完整示例见[custom_document_loader](../../../examples/ecosystem/langchain_knowledge/custom_text_splitter.py)：
...
一个“返回文本包含用户查询中的文本的所有文档”的检索器示例如下，完整示例见[custom_document_loader](../../../examples/ecosystem/langchain_knowledge/custom_retriever.py)：
